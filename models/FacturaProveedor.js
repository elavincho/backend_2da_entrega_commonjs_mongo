...
//     total: { type: Number, default: 0 }, // ✅ Quitar required: true
//     cae: { type: String },
//     fechaVtoCAE: Date,
...
// // ✅ CORRECCIÓN: Middleware para calcular totales antes de guardar
...
//       iva21: this.iva21,
//       iva105: this.iva105,
//       otrosTributos: this.otrosTributos,
//       total: this.total,
//     });
//   } catch (error) {
...
const facturaProveedorSchema = new mongoose.Schema(
  {
    ...
    fechaVtoCAE: Date,
    observaciones: String,
    // ✅ Nuevo campo para vincular con orden de pago
    ordenPagoId: {
      type: Number,
      default: null
    },
