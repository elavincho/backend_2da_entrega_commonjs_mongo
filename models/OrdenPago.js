...
//   formaPago: { type: String, required: true, enum: ['Transferencia', 'Efectivo', 'Cheque', 'Tarjeta'] },
...
// ordenPagoSchema.pre('save', async function(next) {
//   if (this.isNew && !this.numero) {
//     const lastOrden = await mongoose.model('OrdenPago').findOne().sort({ numero: -1 });
